...
export function checkBatteryType(
  formBatteryType: SekBtyType,
  summaryBatteryType: string
): CheckResult[] {
  const summaryBatteryTypeCode = matchBatteryType(summaryBatteryType.trim())
