...
import type { PekSodiumPkgInfo } from '../shared/types'
import { CheckResult } from '../../lithium/shared/types'
import { getIsCargoOnly, getUNNO } from '../../lithium/shared/utils'
 ...
 * @returns
 */
export function sodiumConclusionsCheck(
  conclusions: number,
  isDangerous: boolean,
  pkgInfoByPackCargo: PekSodiumPkgInfo,
